package com.balakrishna.hibernate.entities;
...
public class EmploymentHistory  implements Serializable{
	...
	public String toString() {
		return "EmploymentHistory [employmentHistoryId=" + employmentHistoryId
				+ ", clientName=" + clientName + ", clientAddress1="
				+ clientAddress1 + ", clientAddress2=" + clientAddress2
				+ ", clientZip=" + clientZip + ", clientCountry="
				+ clientCountry + ", person=" + person + "]";
	}
