...
<div class="input-group">
  ...
  <form:input type="text" class="form-control" required="true" path="headlines" placeholder="Enter Headlines" aria-describedby="sizing-addon2"/>
</div>
<br>
...
<form:select class="form-control" required="true" path="cdesignation" id="newstype">

<c:forEach items="${degtypes}" var="type">
...
<div class="form-group">
  ...
  <form:textarea class="form-control" required="true" path="mainstory" rows="5" id="comment"></form:textarea>
</div>
